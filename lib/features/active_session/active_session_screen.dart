...
class _ActiveSessionScreenState extends State<ActiveSessionScreen> {
  ...
  void _resetInactivityTimer() {
    ...
    _inactivityTimer = Timer(const Duration(seconds: 5), () {
      // 5 seconds have passed with no touches -> Lock the hardware screen
      PlatformChannelHelper.turnOffScreen();
    });
  }

  // Fires whenever the user touches the screen
  ...
  Widget build(BuildContext context) {
    ...
    // The Listener catches absolutely every touch event on the screen to reset the timer
    return Listener(
          ...
          body: SafeArea(
            child: Column(
              ...
              children: [
                ...
                _buildTimeBlock(seconds.toString().padLeft(2, '0'), const Color(0xFF333333)),
                ...
                Padding(
                  ...
                  child: _HoldToEjectButton(
                    ...
                    onInteraction: _resetInactivityTimer, // Let the button report its own interactions too
                  ),
                ),
              ],
            ),
...
class _HoldToEjectButtonState extends State<_HoldToEjectButton> with SingleTickerProviderStateMixin {
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    color: _controller.value > 0.4 ? Colors.white : AppConstants.primaryOrange,
                    size: 20,
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: _controller.value > 0.4 ? Colors.white : const Color(0xFF777777),
                      fontSize: 13,
                      fontWeight: FontWeight.w800,
                      letterSpacing: 2.0,
                    ),
