...
class LocalStorageService {
  ...
  static Future<void> saveSession(FreedomSession session) async {
    ...
    final String sessionsJson = prefs.getString(AppConstants.keySessionsList) ?? '[]';
    final List<dynamic> sessionsList = jsonDecode(sessionsJson);

    sessionsList.add(session.toJson());

    await prefs.setString(AppConstants.keySessionsList, jsonEncode(sessionsList));
    ...
    await prefs.setInt(AppConstants.keyTotalMinutes, totalMinutes + session.durationMinutes);
  }
